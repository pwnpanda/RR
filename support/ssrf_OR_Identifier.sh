...
# $1 is domain, $2 is the callback URL (server address), $3 is the logdir, $4 is the tmpdir, $5 is logging directory
if [ -z "$1" ]; then
...
python3 /root/Bug_Bounty/tools/RR/utility/ssrf_uniq.py "$4/$1-ssrf-pl.txt" "$1" "$3/$1-unique-pl.txt" > "$5/$1_ssrf.log"
